...
import { defaultDuration, forenameColor, years, maxBirthsCount, initialRange } from './utils'
  ...
  methods: {
    ...
    updateLines () {
      ...
      const circleData = _.flatMap(this.forenames, (forenameData) => {
        ...
        return _.map(forenameData.births, ({ births, year }) => {
          return { color, year, births, id: forenameData.id + '-' + year }
        })
      })
